...
def SSD300(input_shape, num_classes=21):
    ...
    net['conv1_2'] =  Conv2D(64, (3, 3), name="conv1_2", padding="same", activation="relu")(net['conv1_1'])
    net['pool1'] =  MaxPooling2D((2, 2), name="pool1", padding="same", strides=(2, 2))(net['conv1_2'])
    
    #Blocck2
    net['conv2_1'] = Conv2D(128, (3, 3), name="conv2_1", padding="same", activation="relu")(net['pool1'])
    net['conv2_2'] = Conv2D(128, (3, 3), name="conv2_2", padding="same", activation="relu")(net['conv2_1'])
    net['pool2'] =  MaxPooling2D((2, 2), name="pool2", padding="same", strides=(2, 2))(net['conv2_2'])

    #Block3
    net['conv3_1'] = Conv2D(256, (3, 3), name="conv3_1", padding="same", activation="relu")(net['pool2'])
    net['conv3_2'] = Conv2D(256, (3, 3), name="conv3_2", padding="same", activation="relu")(net['conv3_1'])
    net['conv3_3'] = Conv2D(256, (3, 3), name="conv3_3", padding="same", activation="relu")(net['conv3_2'])
    net['pool3'] = MaxPooling2D((2, 2), name="pool3", padding="same", strides=(2, 2))(net['conv3_3'])
    ...
    net['conv6_2'] = Conv2D(512, (3, 3), padding="same", activation="relu", strides=(2, 2), name="conv6_2")(net['conv6_1'])
    ...
    net['conv7_2'] = Conv2D(256, (3, 3), padding="valid", activation="relu", strides=(2, 2), name="conv7_2")(net['conv7_2'])
    ...
    net['conv8_2'] = Conv2D(256, (3, 3), padding="same", activation="relu", strides=(2, 2), name="conv8_2")(net['conv8_1'])
    ...
    # num_priors  x 3 = 12
    x = Conv2D(12, (3, 3), padding="same", name="conv4_3_norm_mbox_loc")(net['conv4_3_norm'])
